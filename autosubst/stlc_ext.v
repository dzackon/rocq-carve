...
Inductive tm (n_tm : nat) : Type :=
  ...
  | unit : tm n_tm
  | elimunit : tm n_tm -> tm n_tm -> tm n_tm
  | app : tm n_tm -> tm n_tm -> tm n_tm
  | lam : ty -> tm (S n_tm) -> tm n_tm
  | bang : tm n_tm -> tm n_tm
  | letbang : tm n_tm -> tm (S n_tm) -> tm n_tm.

Lemma congr_elimunit {m_tm : nat} {s0 s1 t0 t1 : tm m_tm}
  (H0 : s0 = t0) (H1 : s1 = t1) :
  elimunit m_tm s0 s1 = elimunit m_tm t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => elimunit m_tm x s1) H0))
         (ap (fun x => elimunit m_tm t0 x) H1)).
Qed.

Lemma congr_app {m_tm : nat} {s0 s1 t0 t1 : tm m_tm}
  (H0 : s0 = t0) (H1 : s1 = t1) :
...
Lemma congr_bang {m_tm : nat} {s t : tm m_tm}
  (H : s = t) :
  bang m_tm s = bang m_tm t.
Proof.
exact (eq_trans eq_refl (ap (fun x => bang m_tm x) H)).
Qed.

Lemma congr_letbang {m_tm : nat} {s0 t0 : tm m_tm} {s1 t1 : tm (S m_tm)}
  (H0 : s0 = t0) (H1 : s1 = t1) :
  letbang m_tm s0 s1 = letbang m_tm t0 t1.
Proof.
...
Fixpoint ren_tm {m_tm n_tm : nat} (xi_tm : fin m_tm -> fin n_tm)
(s : tm m_tm) {struct s} : tm n_tm :=
  match s with
  | var_tm _ s0 => var_tm n_tm (xi_tm s0)
  | unit _ => unit n_tm
  | elimunit _ s0 s1 => elimunit n_tm (ren_tm xi_tm s0) (ren_tm xi_tm s1)
...
Lemma up_list_tm_tm (p : nat) {m n_tm : nat}
...
Fixpoint subst_tm {m_tm n_tm : nat} (sigma_tm : fin m_tm -> tm n_tm)
(s : tm m_tm) {struct s} : tm n_tm :=
  match s with
  | var_tm _ s0 => sigma_tm s0
  | unit _ => unit n_tm
  | elimunit _ s0 s1 => elimunit n_tm (subst_tm sigma_tm s0) (subst_tm sigma_tm s1)
  | app _ s0 s1 => app n_tm (subst_tm sigma_tm s0) (subst_tm sigma_tm s1)
  | lam _ s0 s1 => lam n_tm s0 (subst_tm (up_tm_tm sigma_tm) s1)
  | bang _ s0 => bang n_tm (subst_tm sigma_tm s0)
  | letbang _ s0 s1 =>
    letbang n_tm (subst_tm sigma_tm s0) (subst_tm (up_tm_tm sigma_tm) s1)
  end.
...
Lemma upId_list_tm_tm {p m_tm : nat} (sigma : fin m_tm -> tm m_tm)
  (Eq : forall x, sigma x = var_tm m_tm x) :
...
subst_tm sigma_tm s = s :=
  ...
  | unit _ => eq_refl _
  | elimunit _ s0 s1 =>
      congr_elimunit (idSubst_tm sigma_tm Eq_tm s0) (idSubst_tm sigma_tm Eq_tm s1)
  | app _ s0 s1 =>
  ...
  | bang _ s0 => congr_bang (idSubst_tm sigma_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (idSubst_tm sigma_tm Eq_tm s0)
        (idSubst_tm (up_tm_tm sigma_tm) (upId_tm_tm _ Eq_tm) s1)
  end.
...
Fixpoint extRen_tm {m_tm n_tm : nat} (xi_tm : fin m_tm -> fin n_tm)
...
(s : tm m_tm) {struct s} : ren_tm xi_tm s = ren_tm zeta_tm s :=
  ...
  | unit _ => eq_refl (unit n_tm)
  | elimunit _ s0 s1 =>
    congr_elimunit (extRen_tm xi_tm zeta_tm Eq_tm s0)
  ...
  | bang _ s0 => congr_bang (extRen_tm xi_tm zeta_tm Eq_tm s0)
  | letbang _ s0 s1 =>
    congr_letbang (extRen_tm xi_tm zeta_tm Eq_tm s0)
                  (extRen_tm (upRen_tm_tm xi_tm) (upRen_tm_tm zeta_tm)
                             (upExtRen_tm_tm _ _ Eq_tm) s1)
  end.

Lemma upExt_tm_tm {m n_tm : nat} (sigma : fin m -> tm n_tm)
...
Lemma upExt_list_tm_tm {p m n_tm : nat}
...
Fixpoint ext_tm {m_tm n_tm : nat} (sigma_tm tau_tm : fin m_tm -> tm n_tm)
         (Eq_tm : forall x, sigma_tm x = tau_tm x) (s : tm m_tm) {struct s} :
  subst_tm sigma_tm s = subst_tm tau_tm s :=
  match s with
  | var_tm _ s0 => Eq_tm s0
  | unit _ => eq_refl (unit n_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (ext_tm sigma_tm tau_tm Eq_tm s0)
  ...
  | lam _ s0 s1 =>
      congr_lam (eq_refl s0)
                (ext_tm (up_tm_tm sigma_tm) (up_tm_tm tau_tm)
                        (upExt_tm_tm _ _ Eq_tm) s1)
  | bang _ s0 => congr_bang (ext_tm sigma_tm tau_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (ext_tm sigma_tm tau_tm Eq_tm s0)
                    (ext_tm (up_tm_tm sigma_tm) (up_tm_tm tau_tm)
                            (upExt_tm_tm _ _ Eq_tm) s1)
  end.
...
Fixpoint compRenRen_tm {k_tm l_tm m_tm : nat}
  ...
  | unit _ => eq_refl (unit l_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
  ...
  | lam _ s0 s1 =>
      congr_lam (eq_refl s0)
                (compRenRen_tm (upRen_tm_tm xi_tm)
                               (upRen_tm_tm zeta_tm)
                               (upRen_tm_tm rho_tm)
                               (up_ren_ren _ _ _ Eq_tm) s1)
  | bang _ s0 => congr_bang (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
                    (compRenRen_tm (upRen_tm_tm xi_tm)
                                   (upRen_tm_tm zeta_tm)
                                   (upRen_tm_tm rho_tm)
                                   (up_ren_ren _ _ _ Eq_tm) s1)
...
Lemma up_ren_subst_tm_tm {k l m_tm : nat}
...
Lemma up_ren_subst_list_tm_tm {p k l m_tm : nat}
  (xi : fin k -> fin l) (tau : fin l -> tm m_tm) (theta : fin k -> tm m_tm)
  (Eq : forall x, funcomp tau xi x = theta x) :
  forall x,
...
Fixpoint compRenSubst_tm {k_tm l_tm m_tm : nat}
  ...
  | unit _ => eq_refl (unit l_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
  ...
  | bang _ s0 => congr_bang (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
                    (compRenSubst_tm (upRen_tm_tm xi_tm) (up_tm_tm tau_tm)
                                     (up_tm_tm theta_tm)
                                     (up_ren_subst_tm_tm _ _ _ Eq_tm) s1)
  end.

Lemma up_subst_ren_tm_tm {k l_tm m_tm : nat}
...
Lemma up_subst_ren_list_tm_tm {p k l_tm m_tm : nat}
  (sigma : fin k -> tm l_tm) (zeta_tm : fin l_tm -> fin m_tm)
  (theta : fin k -> tm m_tm)
  (Eq : forall x, funcomp (ren_tm zeta_tm) sigma x = theta x) :
  forall x,
...
Fixpoint compSubstRen_tm {k_tm l_tm m_tm : nat}
  ...
  | unit _ => eq_refl (unit l_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
  ...
  | lam _ s0 s1 =>
      congr_lam (eq_refl s0)
                (compSubstRen_tm (up_tm_tm sigma_tm) (upRen_tm_tm zeta_tm)
                                 (up_tm_tm theta_tm)
                                 (up_subst_ren_tm_tm _ _ _ Eq_tm) s1)
  | bang _ s0 => congr_bang (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
                    (compSubstRen_tm (up_tm_tm sigma_tm) (upRen_tm_tm zeta_tm)
                                     (up_tm_tm theta_tm)
                                     (up_subst_ren_tm_tm _ _ _ Eq_tm) s1)
  end.

Lemma up_subst_subst_tm_tm {k l_tm m_tm : nat}
...
Lemma up_subst_subst_list_tm_tm {p k l_tm m_tm : nat}
  (sigma : fin k -> tm l_tm) (tau_tm : fin l_tm -> tm m_tm)
  (theta : fin k -> tm m_tm)
  (Eq : forall x, funcomp (subst_tm tau_tm) sigma x = theta x) :
  forall x,
...
Fixpoint compSubstSubst_tm {k_tm l_tm m_tm : nat}
  ...
  | unit _ =>  eq_refl (unit l_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
  ...
  | lam _ s0 s1 =>
      congr_lam (eq_refl s0)
                (compSubstSubst_tm (up_tm_tm sigma_tm) (up_tm_tm tau_tm)
                                   (up_tm_tm theta_tm)
                                   (up_subst_subst_tm_tm _ _ _ Eq_tm) s1)
  | bang _ s0 => congr_bang (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
                    (compSubstSubst_tm (up_tm_tm sigma_tm) (up_tm_tm tau_tm)
                                       (up_tm_tm theta_tm)
                                       (up_subst_subst_tm_tm _ _ _ Eq_tm) s1)
  end.

Lemma renRen_tm {k_tm l_tm m_tm : nat}
  (xi_tm : fin m_tm -> fin k_tm) (zeta_tm : fin k_tm -> fin l_tm)
  (s : tm m_tm) :
...
Lemma renRen'_tm_pointwise {k_tm l_tm m_tm : nat}
  (xi_tm : fin m_tm -> fin k_tm) (zeta_tm : fin k_tm -> fin l_tm) :
...
Lemma renSubst_tm {k_tm l_tm m_tm : nat}
...
Lemma renSubst_tm_pointwise {k_tm l_tm m_tm : nat}
  (xi_tm : fin m_tm -> fin k_tm) (tau_tm : fin k_tm -> tm l_tm) :
...
Lemma substRen_tm {k_tm l_tm m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (zeta_tm : fin k_tm -> fin l_tm)
  (s : tm m_tm) :
...
Lemma substRen_tm_pointwise {k_tm l_tm m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (zeta_tm : fin k_tm -> fin l_tm) :
...
Lemma substSubst_tm {k_tm l_tm m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (tau_tm : fin k_tm -> tm l_tm)
  (s : tm m_tm) :
...
Lemma substSubst_tm_pointwise {k_tm l_tm m_tm : nat}
  (sigma_tm : fin m_tm -> tm k_tm) (tau_tm : fin k_tm -> tm l_tm) :
...
Lemma rinstInst_up_tm_tm {m n_tm : nat} (xi : fin m -> fin n_tm)
  (sigma : fin m -> tm n_tm)
...
Lemma rinstInst_up_list_tm_tm {p m n_tm : nat}
...
Fixpoint rinst_inst_tm {m_tm n_tm : nat}
         (xi_tm : fin m_tm -> fin n_tm) (sigma_tm : fin m_tm -> tm n_tm)
         (Eq_tm : forall x, funcomp (var_tm n_tm) xi_tm x = sigma_tm x)
         (s : tm m_tm) {struct s} :
  ...
  | unit _ => eq_refl (unit n_tm)
  | elimunit _ s0 s1 =>
      congr_elimunit (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
  ...
  | bang _ s0 => congr_bang (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
  | letbang _ s0 s1 =>
      congr_letbang (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
                    (rinst_inst_tm (upRen_tm_tm xi_tm) (up_tm_tm sigma_tm)
                                   (rinstInst_up_tm_tm _ _ Eq_tm) s1)
  end.

Lemma rinstInst'_tm {m_tm n_tm : nat} (xi_tm : fin m_tm -> fin n_tm)
  (s : tm m_tm) : ren_tm xi_tm s = subst_tm (funcomp (var_tm n_tm) xi_tm) s.
Proof.
exact (rinst_inst_tm xi_tm _ (fun n => eq_refl) s).
Qed.

Lemma rinstInst'_tm_pointwise {m_tm n_tm : nat}
...
Lemma varL'_tm {m_tm n_tm : nat} (sigma_tm : fin m_tm -> tm n_tm)
  (x : fin m_tm) : subst_tm sigma_tm (var_tm m_tm x) = sigma_tm x.
Proof.
exact (eq_refl).
Qed.

Lemma varL'_tm_pointwise {m_tm n_tm : nat}
...
Lemma varLRen'_tm {m_tm n_tm : nat} (xi_tm : fin m_tm -> fin n_tm)
  (x : fin m_tm) : ren_tm xi_tm (var_tm m_tm x) = var_tm n_tm (xi_tm x).
Proof.
exact (eq_refl).
Qed.

Lemma varLRen'_tm_pointwise {m_tm n_tm : nat}
  (xi_tm : fin m_tm -> fin n_tm) :
...
#[global]
Instance subst_tm_morphism  {m_tm n_tm : nat}:
...
#[global]
Instance subst_tm_morphism2  {m_tm n_tm : nat}:
...
#[global]
Instance ren_tm_morphism  {m_tm n_tm : nat}:
 (Proper (respectful (pointwise_relation _ eq) (respectful eq eq))
    (@ren_tm m_tm n_tm)).
Proof.
exact (fun f_tm g_tm Eq_tm s t Eq_st =>
...
#[global]
Instance ren_tm_morphism2  {m_tm n_tm : nat}:
 (Proper (respectful (pointwise_relation _ eq) (pointwise_relation _ eq))
    (@ren_tm m_tm n_tm)).
Proof.
